...
local function drawRegisterName()
  ...
  hline(4)
  centreText(6,  "Initial Setup \4 Player Name", colors.white)
  centreText(7,  "(entered by an admin when installing the meter)", colors.gray)
  centreText(9,  "Type the customer's name on the computer", colors.lightGray)
  centreText(10, "keyboard, then press ENTER.", colors.lightGray)
  writeAt(3, 12, "> " .. regName .. "_", colors.lime)
  hline(H-1)
  centreText(H, "Beyond Energy Co. | BeyondSMP v"..VERSION, colors.gray)
  drawButtons()
end

local function drawRegisterTariff(name)
  cls(); clearButtons()
  centreText(2, "BEYOND ENERGY", colors.yellow)
  centreText(3, "New Customer Setup", colors.lightGray)
  hline(4)
  centreText(6, "Step 2 of 2: Choose Your Tariff", colors.white)
  centreText(7, "Hi " .. name .. "! Select a tariff below.", colors.lightGray)
  hline(9)
...
local function drawRegisterType(name)
  ...
  centreText(3, "New Customer Setup", colors.lightGray)
  hline(4)
  centreText(6, "Step 1 of 2: Connection Type", colors.white)
